...
StatForAgeF <- as.tibble(read.csv('StatForAgeF.csv'))
StatForAgeM <- as.tibble(read.csv('StatForAgeM.csv'))
```
...
FilteredAgePatientData <- FilteredAgePatientData %>%
  mutate(L1Age = lapply(Age.in.months,
                        function(months)))
FilteredAgePatientData$L1Age <- 
