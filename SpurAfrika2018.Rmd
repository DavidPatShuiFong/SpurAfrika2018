...
ChildFindingsData <- ChildPatientData %>%
  ...
  # capitalize the first letter of each finding
  mutate(Finding = paste(toupper(substring(Finding,1,1)), substring(Finding,2), sep = ''))
```
...
``` {r}
sort(unique(ChildFindingsData$Finding))
```
